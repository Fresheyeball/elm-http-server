...
Elm.Http.Server.make = function (_elm) {
   ...
   if (_elm.Http.Server.values)
   return _elm.Http.Server.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var writeAs = F3(function (header,
   res,
   html) {
      return A2($Task.andThen,
      A2($Task.andThen,
      A3(writeHead,200,header,res),
      write(html)),
      end);
   });
   ...
   _elm.Http.Server.values = {_op: _op
...
Elm.Http.Server.Isomorphic.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Server = _elm.Http.Server || {};
   _elm.Http.Server.Isomorphic = _elm.Http.Server.Isomorphic || {};
   if (_elm.Http.Server.Isomorphic.values)
   return _elm.Http.Server.Isomorphic.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Http.Server.Isomorphic",
   $Basics = Elm.Basics.make(_elm),
   $FS = Elm.FS.make(_elm),
   ...
   var embed = F2(function (_v0,
   html) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var joinOn = A2($Basics.flip,
                 $String.join,
                 _v0._0);
                 var g = function (js) {
                 ...
                 $FS.readFile(_v0._1),
                 function ($) {
                    return $Task.succeed(g($));
                 });
              }();}
         _U.badCase($moduleName,
         "between lines 11 and 36");
      }();
   });
   var writeElm = F3(function (res,
   elmId,
   html) {
      return A2($Task.andThen,
      A2(embed,elmId,html),
      $Http$Server.writeHtml(res));
   });
   _elm.Http.Server.Isomorphic.values = {_op: _op
                                        ,embed: embed
                                        ,writeElm: writeElm};
   return _elm.Http.Server.Isomorphic.values;
};
...
Elm.Main.make = function (_elm) {
   ...
   var elmId = {ctor: "_Tuple2"
               ,_0: _L.fromArray(["Main"])
               ,_1: "example/isomorphic-templating/main.js"};
   var view = function (m) {
      return A2($Html.div,
      _L.fromArray([]),
...
Elm.Server.make = function (_elm) {
   ...
   if (_elm.Server.values)
   return _elm.Server.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $FS = Elm.FS.make(_elm),
   $Http$Server = Elm.Http.Server.make(_elm),
   $Http$Server$Isomorphic = Elm.Http.Server.Isomorphic.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var route = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var _v4 = $Http$Server.method(_v0._0);
                 switch (_v4.ctor)
                 {case "GET":
                    return function () {
                         var _v5 = $Http$Server.url(_v0._0);
                         switch (_v5)
                         {case "/":
                            return A2($Http$Server.writeHtml,
                              _v0._1,
                              "<h1>Wowzers</h1>");
                            case "/foo":
                            return A2($Http$Server$Isomorphic.writeElm,
                              _v0._1,
                              $Main.elmId)($Main.view($Main.initial));}
                         return A2($Http$Server.writeHtml,
                         _v0._1,
                         "<h1>404</h1>");
                      }();
                    ...
                    case "POST":
                    return $Http$Server.writeJson(_v0._1)($Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                                                            ,_0: "foo"
                                                                                            ,_1: $Json$Encode.string("bar")}])));}
                 return $Http$Server.writeJson(_v0._1)($Json$Encode.string("fail"));
              }();}
         _U.badCase($moduleName,
   ...
   var server = $Signal.mailbox({ctor: "_Tuple2"
                                ,_0: $Http$Server.emptyReq
                                ,_1: $Http$Server.emptyRes});
   var reply = Elm.Native.Task.make(_elm).performSignal("reply",
   A2($Signal._op["<~"],
   route,
   $Signal.dropRepeats(server.signal)));
   var serve = Elm.Native.Task.make(_elm).perform(A3($Http$Server.createServer$,
   server.address,
   8080,
   "Listening on 8080"));
   _elm.Server.values = {_op: _op
                        ,server: server
                        ,route: route};
   return _elm.Server.values;
};
...
Elm.VDOMtoHTML.make = function (_elm) {
   ...
   if (_elm.VDOMtoHTML.values)
   return _elm.VDOMtoHTML.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "VDOMtoHTML",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _elm.VDOMtoHTML.values = {_op: _op
                            ,toHTML: toHTML};
   return _elm.VDOMtoHTML.values;
};
